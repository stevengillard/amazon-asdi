...
from .utils import PY36, is_exception, other_paths, setup_logging

private = re.compile("_[^_]")

logger = logging.getLogger('fsspec')
if "FSSPEC_LOGGING_LEVEL" in os.environ:
    setup_logging(logger=logger, level=os.environ.get("FSSPEC_LOGGING_LEVEL"))
...
def sync(loop, func, *args, timeout=None, **kwargs):
    ...
    # Disable garbage collection while there are tasks being executed on the 
    # other thread. This prevents destructors being called that can result 
